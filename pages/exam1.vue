<template>
  <div>
          ...
          <b-card no-body>
            <b-tabs card pills v-model="tabIndex" class="exam plan" active-nav-item-class="Qactive">
              ...
              <b-tab :title-link-class="[{'filled':answerScore[7]}]">
               ...
               <radioQuiz exam :lock="quizLocked" :forceEmpty="isNull" :question="$t('Questions.q8')" qId="7" :refill="Refill('7')" @response="calculateAnswer($event,4,7)" />
              </b-tab>
    ...
    <div class="bottomNav planSection" v-else>
      ...
      <microlearning  youAreHere size="140" path="exam1" time="25" :completion="parseInt($store.getters['plan/getScore'],10)" imagePath="P-Test.svg" :text="$t('Test')" :highlighted="chosenScenario == 'justExam'" type="exam" questionNum="10" />
    </div>
