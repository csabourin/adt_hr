        ...
        <div role="tablist" class="transcriptionBox" style="width: 100%;">
          <b-card no-body class="mb-1 text-left">
            ...
            <b-collapse id="translationbox" accordion="translation-box" role="tabpanel">
              <b-card-body>
                <p><b>[00:00:02 Title is shown onscreen.]</b></p>
                <h2>Introduction</h2>
