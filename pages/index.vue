      ...
      <b-col>
        <b-alert show="true" style="margin-bottom: 25px; margin-top: 25px;">
          <div v-if="$i18n.locale=='en'">
            <p>Thank you for following this new course “Managing People Effectively .” As this is a work in progress, we are seeking your feedback on the learning experience. We appreciate you taking a few minutes to tell us what worked well, any issues you faced and what we can fix to make it better. It will take you 5 to 10 minutes to complete the questionnaire.</p>
...
/>
        ...
        <div role="navigation" class="courseSection spendSection" :style="{ backgroundImage: `url(${spendbgBarUrl})` }" :aria-label="$t('spend') + ' - Navigation'">
          <microlearning imagePath="FunctionPart1.svg" path="functionPart1" time="20" :text="$t('organizationClassification')"  :completion="$store.state.currentPlaying.spendPart1_player" type="video" />
...
<i18n>
  
  {
    "en":{
      ...
      "transcriptText":"<p><b>[00:00:02 Title is shown onscreen.]</b></p><h2>Introduction</h2><p><b>Charlaine Lapointe: </b>Welcome! You’re in the right place if you’re a manager looking to learn about how to make responsible use of public funds. There are many reasons why managers like you might take this course.</p><ul><li>You might be a new manager who’s new at financial delegation and you need to learn everything there is to know.</li><li>You could be an experienced manager, but new to government and looking to leverage your experience by connecting what you already know.</li><li>Maybe you just came back from a parental leave and you could really use a refresher.</li><li>Or perhaps you’re an experienced manager in government and you need to recertify every 5 years in order to continue exercising your financial delegation. Maybe you just really want to get to the test!</li></ul><p>Whatever brought you here, you’re in charge of your own learning. Think of this as a &ldquo;choose your own adventure&rdquo; kind of experience and take what you need in order to succeed. If all you need is to take the test because you’re already pretty familiar with the content, then, by all means, start with that.</p><p>If you just need an overview or a refresher, then simply review the key messages of each phase to get the key highlights and tools.</p><p>You'll also want to make use of the handy features on your screen, like the toolbox on the top right, which has tools and resources to help you on the job.</p><p>If you’re learning this for the first time, then take the time to go through each section, do the in-depth learning activities, and review the tools and resources. We promise it’s worth the effort!</p><p><strong>[00:01:22 Sample images of module pages are shown onscreen.]</strong></p><p>You’re probably wondering about the test.</p><p>Passing the test for this course is mandatory before you can exercise financial delegation.</p><p>The passing grade is 80% for each of the sections.</p><p><strong>[00:01:43 Sample images of test examples are shown onscreen.]</strong></p><p>Each section should take you around 15 to 20 minutes to complete. </p><p>You can access course materials during the test and you can take it as many times as you need.</p><p><strong>[00:01:53 Sample images of module pages are shown onscreen.]</p></strong><p>In the end, how you use this course is really up to you! It will remain accessible to you so you can come back to consult different sections and tools, whatever you need on the job!</p><p>We’re rooting for you! Because when you steward public funds well, you succeed in your career. And, more importantly, you serve Canadians well, with transparency and accountability. And that’s the bottom line.</p>",
    ...
    "fr":{
      ...
      "takeCourseText":"Pour prendre la totalité du cours, commencez par le premier module de la section Éléments de base en choisissant « Délégation en matière de ressources humaines » et continuez à avancer, section par section pour terminer le cours au complet.",
      "refreshKnowledge":"Je veux rafraîchir mes connaissances",
      "refreshKnowledgeText":"Avec cette option, vous examinerez les Messages clés dans chacune des sections Éléments de base, Fonction et processus et Normes et valeurs fondamentales.",
      "takeExam":"Je veux seulement prendre le test",
      "takeExamText":"Avec cette option, vous ferez trois tests, un dans la section Éléments de base, un dans la section Fonction et processus et un dans la section Normes et valeurs fondamentales."
    }
  }
