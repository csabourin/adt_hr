<template>
  <div>
    ...
    <div class="bottomNav spendSection" v-else>
      ...
      <microlearning youAreHere path="exam2" size="140" time="25" imagePath="S-Test.svg" :text="$t('Test')" :completion="parseInt($store.getters['spend/getScore'],10)" :highlighted="chosenScenario == 'justExam'" type="exam" questionNum="20" />
    </div>
