<template>
  <div>
    ...
    <div class="bottomNav reportSection">
      ...
      <microlearning youAreHere :completion="$store.state.currentPlaying.reportPart2_player" path="valuesPart3" imagePath="ValuesPart3.svg" size="140" time="20" :text="$t('OfficialLanguages')" type="video" />
