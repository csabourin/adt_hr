<template>
  <div>
    ...
    <section>
      <b-row>
        <b-col>
          <videoPlayer ref="vp" enVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_dl3cwkfc/flavorId/0_j54u7n1p/name/a.mp4" frVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_oq1n7g7y/flavorId/0_wfw7vur2/name/a.mp4" chapters chapterFile="valuesPart3.vtt" ccFile="ValuesPart3_captions.vtt" :restartAt="parseInt(thatPoint)" toResume="setValuesPart3" :modalArray="modalArray" @timeupdate="updatePercent($event)" />
        </b-col>
      </b-row>
      <b-container>
        <b-row>
