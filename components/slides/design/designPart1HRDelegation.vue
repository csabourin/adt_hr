...
<i18n>{
  "en": {
  "instructions":"Using the sample <a href='~/static/jobaidHTML/en/delegChart_en.html' target='_blank'>sub-delegation instrument for HR authorities</a>, identify the lowest level of authority that can approve the request.",
  ...
  "fr": {
  "instructions":"À l’aide de l’exemple d’<a href='~/assets/fr/delegChart_fr.html' target='_blank'>instrument de subdélégation pour les pouvoirs en matière de RH</a>, déterminez le niveau décisionnel minimal requis pour approuver la demande.",
