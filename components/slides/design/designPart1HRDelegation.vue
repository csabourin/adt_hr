...
<i18n>{
  ...
  "fr": {
  "instructions":"À l’aide de l’exemple d’<a href='jobaidHTML/delegChart_fr.html' target='_blank'>instrument de subdélégation pour les pouvoirs en matière de RH</a>, déterminez le niveau décisionnel minimal requis pour approuver la demande.",
